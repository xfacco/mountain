...
export default function CompareClient() {
    ...
    const scroll = (direction: 'left' | 'right') => {
        if (scrollRef.current) {
            // On mobile use the full column width, on desktop use a fixed amount
            const isMobile = window.innerWidth < 1024;
            const columnWidth = isMobile ? window.innerWidth - 128 : 260;
                                ...
                                <table className="w-full text-left border-separate border-spacing-0 min-w-max">
                                    <thead>
                                        <tr className="bg-white/95 backdrop-blur-md">
                                            <th className="p-4 w-32 md:w-48 border-r border-slate-100 last:border-r-0 bg-white sticky left-0 z-10 shrink-0">
                                                <div className="flex flex-col justify-center">
                                                    <span className="text-[10px] font-black uppercase tracking-widest text-slate-400">Location</span>
                                                </div>
                                            </th>
                                            {selectedLocations.map((loc) => (
                                                <th key={`header-name-${loc.id}`} className="snap-start p-4 w-[calc(100vw-128px)] md:w-[300px] lg:min-w-[250px] align-middle border-r border-slate-100 last:border-r-0 bg-white relative group">
                                                    <button
                                                        onClick={() => toggleLocation(loc)}
                            ...
                            <table className="w-full text-left border-separate border-spacing-0 min-w-max">
                                <tbody className="text-slate-700">
                                    ...
                                    <tr className="bg-slate-50 hidden lg:table-row">
                                        <td className="p-4 w-32 md:w-48 border-r border-b border-slate-100 sticky left-0 z-10 bg-slate-50"></td>
                                        {selectedLocations.map((loc) => (
                                            <td key={`img-row-${loc.id}`} className="snap-start p-4 w-[calc(100vw-128px)] md:w-[300px] lg:min-w-[250px] border-r border-b border-slate-100 last:border-r-0">
                                    ...
                                    <tr>
                                        <td className="p-4 font-bold text-slate-900 bg-slate-50/50 min-w-[128px] sticky left-0 z-10 border-r border-slate-100">
                                            {t('altitude')}
                                        </td>
                                        {selectedLocations.map((loc) => (
                                            <td key={loc.id} className="snap-start p-4 w-[calc(100vw-128px)] md:w-[300px] lg:min-w-[250px] align-top font-mono text-sm text-slate-700 border-r border-slate-100 last:border-r-0">
                                    ...
                                    <tr>
                                        ...
                                        {selectedLocations.map((loc) => (
                                            <td key={loc.id} className="snap-start p-4 w-[calc(100vw-128px)] md:w-[300px] lg:min-w-[250px] align-top border-r border-slate-100 last:border-r-0">
                                    ...
                                    <tr className="border-t border-slate-200">
                                        ...
                                        {selectedLocations.map((loc) => (
                                            <td key={loc.id} className="snap-start p-4 w-[calc(100vw-128px)] md:w-[300px] lg:min-w-[250px] align-top border-r border-slate-100 last:border-r-0 space-y-3">
                                                <div>
                                    ...
                                    >
                                        <td colSpan={selectedLocations.length + 1} className="p-2 text-left lg:text-center text-xs font-bold text-slate-500 uppercase tracking-wider">

                                            ...
                                            .map((loc) => {
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={`flex flex-col md:flex-row items-center md:items-start gap-2 md:gap-3 p-2 md:p-3 rounded-xl border transition-all text-center md:text-left ${isSelected
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                            <div className="font-bold text-slate-900 text-[11px] md:text-sm line-clamp-1">
                                                                {loc.name}
                                                            </div>
